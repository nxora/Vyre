...
export default function PostCard({ post }: { post: any }) {
  ...
  return (
    ...
    >
      ...
      <button onClick={(e) => { e.preventDefault(); toggleLike(); }} aria-label={isLiked ? "Unlike post" : "Like post"} className={`mt-2 flex items-center gap-1 text-sm transition-colors ${isLiked
          ? "text-red-500"
